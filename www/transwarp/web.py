...
def redirect(location):
    ...
    >>> raise redirect('http://www.hsing.com/')
    Traceback (most recent call last):
      ...
    RedirectError: 301 Moved Permanently, http://www.hsing.com/
    '''
...
def found(location):
    ...
    >>> raise found('http://www.hsing.com/')
    Traceback (most recent call last):
      ...
    RedirectError: 302 Found, http://www.hsing.com/
    '''
...
def seeother(location):
    '''
    Do temporary redirect.
    >>> raise seeother('http://www.hsing.com/')
    Traceback (most recent call last):
      ...
    RedirectError: 303 See Other, http://www.hsing.com/
    >>> e = seeother('http://www.hsing.com/seeother?r=123')
    >>> e.location
    'http://www.hsing.com/seeother?r=123'
    '''
...
class Jinja2TemplateEngine(TemplateEngine):
    ...
    >>> engine('jinja2-test.html', dict(name='HSING', posted_at=datetime.datetime(2014, 6, 1, 10, 11, 12)))
    '<p>Hello, HSING.</p><span>2014-06-01 10:11:12</span>'
    '''
